// Transaction info
// Function: 0x68476f9d437e3f32fd262ba898b5e3ee0a23a1d586a6cf29a28add35f253f6f7::meso::deposit
 ...
 */
export async function deposit(fungibleAsset: string, balance: number, account: Account) {
  ...
  await signAndSubmitTransaction(
    {
      function: generateMoveFunction({ method: 'deposit' }),
